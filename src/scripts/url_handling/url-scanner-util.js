    ...
    // Pure function to animate other rows
    const animateOtherRows = (linkScannerRows) => {
    ...
    // Pure function to handle input
    const handleInput = (inputField, dropdown) => {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        inputField.addEventListener('input', () => handleInput(inputField, dropdown));
        inputField.addEventListener('paste', () => handleInput(inputField, dropdown));
